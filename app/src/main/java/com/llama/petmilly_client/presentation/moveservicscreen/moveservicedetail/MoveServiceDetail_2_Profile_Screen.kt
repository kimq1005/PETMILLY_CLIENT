...
@Composable
fun MoveServiceDetail_2_Profile_1_Screen(
    ...
    Column(
        ...
        Box(
            ...
            ButtonScreen(
                ...
                if (ischeck) {
                    navController.navigate(Common.MOVESERVICEDETAILSCREEN_2_PROFILE_2)
                }
            }
...
@Composable
fun MoveServiceDetail_2_Profile_2_Screen(
    navController:NavController,
    viewModel: MoveServiceDetailViewModel,
    activity: Activity
) {
...
//            CheckedCheckBox(clickcolor = Category_Cliked)
        ...
        Box(
            ...
            ButtonScreen(
                ...
                if (ischeck) {
                    navController.navigate(Common.MOVESERVICEDETAILSCREEN_3_INPUT)
                }
            }
